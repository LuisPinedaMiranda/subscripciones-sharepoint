...
extendFactory(File, {
     ...
     */
    setStreamContentChunked: asCancelableScope(async function (stream, progress) {
        if (!isFunc(progress)) {
            progress = () => void (0);
        }
...
extendFactory(Files, {
     ...
     */
    addChunked: asCancelableScope(async function (url, content, progress, shouldOverWrite = true, chunkSize = 10485760) {
        ...
        if ("function" === typeof content.read) {
            return file.setStreamContentChunked(content, progress);
        }
